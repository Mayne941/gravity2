...
def VirusClassificationAndEvaluation (
	...
	if "PPHMMSignatureTable_Dict_coo" in list(globals().keys()):	globals()["PPHMMSignatureTable_Dict"] = {RefVirusGroup:PPHMMSignatureTable_coo.toarray() for RefVirusGroup, PPHMMSignatureTable_coo in PPHMMSignatureTable_Dict_coo.items()}
	if "PPHMMLocationTable_Dict_coo" in list(globals().keys()):	globals()["PPHMMLocationTable_Dict"] = {RefVirusGroup:PPHMMLocationTable_coo.toarray() for RefVirusGroup, PPHMMLocationTable_coo in PPHMMLocationTable_Dict_coo.items()}
	...
	TaxoLabelList_UcfVirus	= list(map('_'.join, list(zip(	["Query%.4d"%i for i in range(len(SeqIDLists_UcfVirus))],
